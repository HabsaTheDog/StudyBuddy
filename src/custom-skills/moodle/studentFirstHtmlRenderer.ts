...
.filter-row{display:flex;gap:.35rem;overflow-x:auto;padding-bottom:.2rem}.filter-chip{height:44px;white-space:nowrap;border:1px solid var(--sb-line);background:white;color:var(--sb-muted);padding:.45rem .65rem;cursor:pointer;font-size:.78rem;font-weight:800}.filter-chip span{margin-left:.35rem;color:var(--sb-cyan)}.filter-chip:hover,.filter-chip.is-active{background:var(--sb-navy);border-color:var(--sb-navy);color:white}
.source-layout{display:grid;grid-template-columns:minmax(340px,.9fr) minmax(390px,1.1fr);height:min(68vh,700px);min-height:480px;border:1px solid var(--sb-line);min-width:0}
...
@media(max-width:980px){
  :root{--rail:190px}.topbar{grid-template-columns:var(--rail) minmax(0,1fr) auto}.source-layout{grid-template-columns:minmax(300px,.95fr) minmax(330px,1.05fr)}.source-row{grid-template-columns:38px minmax(0,1fr)}.source-actions{grid-column:2}.button-quiet{padding-left:0}
}
@media(max-width:760px){
  ...
  .source-toolbar{grid-template-columns:1fr}.source-layout{display:flex;flex-direction:column;height:auto;min-height:0}.source-results{height:60vh;min-height:380px;border-right:0}.preview-pane{display:none;position:fixed;z-index:50;inset:.5rem;background:var(--sb-soft);box-shadow:0 0 0 100vmax rgba(23,35,67,.55);height:auto}.preview-pane.is-open{display:grid}.preview-close{display:block}.source-row{grid-template-columns:38px minmax(0,1fr)}.source-actions{grid-column:2}.preview-body{min-height:0}
}
