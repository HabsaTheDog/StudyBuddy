...
describe("practice-corpus source links", () => {
  it("preserves direct Moodle activity URLs and renders safe new-tab links", () => {
    const extractedData = {
      sources: [
        { id: "t1", url: "https://moodle.example.edu/mod/resource/view.php?id=101" },
        { id: "ode", url: "https://moodle.example.edu/mod/resource/view.php?id=102" },
        { id: "ode2", url: "https://moodle.example.edu/mod/resource/view.php?id=103" },
      ],
    };
    ...
    expect(content?.sources.find((source) => source.id === "mt1")?.url)
      .toBe("https://moodle.example.edu/mod/resource/view.php?id=101");
    expect(content?.sources.find((source) => source.id === "ode")?.url)
      .toBe("https://moodle.example.edu/mod/resource/view.php?id=102");
    ...
    expect(html).toContain('href="https://moodle.example.edu/mod/resource/view.php?id=101"');
