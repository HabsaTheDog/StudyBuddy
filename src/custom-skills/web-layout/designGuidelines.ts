...
export function offlineHtmlRules(): string {
  return [
    ...
    "- No CSS @import.",
    "- No fetch, XMLHttpRequest, WebSocket, EventSource, sendBeacon, or dynamic remote import().",
    "- A locked-down offline Content-Security-Policy is injected automatically; do not weaken or replace it.",
