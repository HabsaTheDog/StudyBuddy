...
- The optimization campaign `quiz-minimal-parallel` is local diagnostic state. Its initial two-page baseline came from incident evidence, not a rerun of the controlled fixture; do not interpret its numeric comparison as a measured production speedup.
