...
- Vienna deadline: July 22, 2026 at 02:00 CEST
- Public project name: Study Buddy
- License: MIT

## Documents

- [`SUBMISSION.md`](SUBMISSION.md): copy-ready Devpost project story
...
The local `hackathon-submission-private/` directory is ignored by Git and may be used to assemble the Devpost upload. Git-ignore is not encryption: anything placed in a ZIP and uploaded is disclosed to its recipients. Do not place personal production credentials or long-lived private calendar URLs there.
