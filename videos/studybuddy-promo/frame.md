...
typography:
  ...
  body:      { fontFamily: "Montserrat", cqw: 0.85, weight: 500, lineHeight: 1.6 }
  subtitle:  { fontFamily: "Montserrat", cqw: 0.95, weight: 500, tracking: "0.18em", upper: true }
  pill-text: { fontFamily: "Montserrat", cqw: 0.75, weight: 500, tracking: "0.12em", upper: true }
  label:     { fontFamily: "Montserrat", px: 14, weight: 500, tracking: "0.1em", upper: true }
  # — display / hero ramp (Montserrat, ink, sentence case) —
  card-headline:{ fontFamily: "Montserrat", cqw: 1.9, weight: 800, lineHeight: 1.1 }
  orbit-numeral:{ fontFamily: "Montserrat", cqw: 2.6, weight: 800, lineHeight: 1.0 }
  quote-display:{ fontFamily: "Montserrat", cqw: 4.2, weight: 500, lineHeight: 1.3, tracking: "-0.01em" }
  stat-number: { fontFamily: "Montserrat", cqw: 3.6, weight: 800, lineHeight: 1.0, tracking: "-0.03em" }
  section-headline:{ fontFamily: "Montserrat", cqw: 4.0, weight: 800, lineHeight: 1.05, tracking: "-0.01em" }
  headline:    { fontFamily: "Montserrat", cqw: 5.0, weight: 800, lineHeight: 1.05, tracking: "-0.02em" }
...
- **Fonts** — already set to **Montserrat** (display) / **Noto Sans Mono** (body); ignore any preset font name lingering in prose.
- **Weights** — the brand font ships `{500, 800}` only; every weight is clamped to these — ignore higher preset weights (e.g. 600/700) in prose.
...
```html
<style>
@font-face{font-family:"Montserrat";font-weight:800;font-style:normal;font-display:block;src:url("assets/fonts/Montserrat-ExtraBold.otf") format("opentype");}
@font-face{font-family:"Montserrat";font-weight:500;font-style:normal;font-display:block;src:url("assets/fonts/Montserrat-Medium.otf") format("opentype");}
@font-face{font-family:"Noto Sans Mono";font-weight:400;font-style:normal;font-display:block;src:url("assets/fonts/NotoSansMono-Regular.ttf") format("truetype");}
</style>
```
